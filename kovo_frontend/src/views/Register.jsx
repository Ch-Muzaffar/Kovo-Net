...
export default function Register() {
    ...
    if (step === 1) {
      ...
      try {
        await register(form, () => {
          ...
          showToast('Welcome to KOVO!', 'success');
          navigate('feed');
        });
      } catch (err) {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', background: 'var(--bg-primary)' }}>
      ...
      <div className="auth-left-panel" style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <button onClick={() => navigate('landing')} style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'none', border: 'none', cursor: 'pointer', marginBottom: '2.5rem', padding: 0 }}>
            <div style={{ width: '44px', height: '44px', borderRadius: '12px', background: 'rgba(255,255,255,0.15)', border: '1px solid rgba(255,255,255,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 900, fontSize: '0.85rem', color: '#fff' }}>KN</div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '1px', lineHeight: 1 }}>
              <span style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 900, fontSize: '1.2rem', color: '#fff', letterSpacing: '-0.02em', lineHeight: 1 }}>KOVO</span>
              <span style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 700, fontSize: '0.58rem', color: 'rgba(255,255,255,0.65)', letterSpacing: '0.1em', lineHeight: 1, textTransform: 'uppercase' }}>NET</span>
            </div>
          </button>
      ...
      {/* RIGHT PANEL: Form */}
      <div className="auth-right-panel-scroll" style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem 1.75rem', overflowY: 'auto' }}>
        <div style={{ width: '100%', maxWidth: '440px' }} className="page-enter">
          ...
          <button className="auth-mobile-logo" onClick={() => navigate('landing')}
            ...
            <div style={{ width: '34px', height: '34px', borderRadius: '9px', background: 'var(--gradient-btn)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, color: '#fff', fontSize: '0.7rem', fontFamily: "'Plus Jakarta Sans',sans-serif" }}>KN</div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '1px', lineHeight: 1 }}>
              <span style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 900, fontSize: '1.05rem', color: 'var(--text-primary)', letterSpacing: '-0.02em', lineHeight: 1 }}>KOVO</span>
              <span style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 700, fontSize: '0.55rem', color: 'var(--text-muted)', letterSpacing: '0.1em', lineHeight: 1, textTransform: 'uppercase' }}>NET</span>
            </div>
          </button>
