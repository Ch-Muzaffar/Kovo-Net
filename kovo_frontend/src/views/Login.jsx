  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await login(email, password, () => {
        ...
        showToast('Welcome back to KOVO NET!', 'success');
        navigate('feed');
      });
    } catch (err) {
    ...
    <div style={{ minHeight: '100vh', display: 'flex', background: 'var(--bg-primary)' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '1px', lineHeight: 1 }}>
              <span style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 900, fontSize: '1.25rem', color: '#fff', letterSpacing: '-0.02em', lineHeight: 1 }}>KOVO</span>
              <span style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 700, fontSize: '0.6rem', color: 'rgba(255,255,255,0.65)', letterSpacing: '0.1em', lineHeight: 1, textTransform: 'uppercase' }}>NET</span>
            </div>
          </button>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: '420px' }} className="page-enter">
          ...
          >
            <div style={{ width: '36px', height: '36px', borderRadius: '10px', background: 'var(--gradient-btn)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, color: '#fff', fontSize: '0.7rem', fontFamily: "'Plus Jakarta Sans',sans-serif" }}>KN</div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '1px', lineHeight: 1 }}>
