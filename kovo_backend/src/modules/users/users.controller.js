...
const { getProfile, updateProfile, updateDemographics, getPoints, getLedgerHistory, deactivateUser, searchUsers, getFullProfile } = require('./users.service');
...
class UsersController {
  ...
  static async getFullProfile(req, res, next) {
    try {
      const result = await getFullProfile(req.user.id, req.params.userId);
